    ...
    >
      ...
      >
        ...
        <Pressable
          ...
          disabled={!isValid || createMutation.isPending || uploadMutation.isPending}
        >
          {createMutation.isPending ? (
            ...
            <>
              ...
              <RNText style={styles.submitBtnText}>Add Expense</RNText>
            </>
          )}
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  dateModalTitle: { fontSize: 17, fontWeight: "600" },
  dateModalDone: {
    fontSize: 17,
    fontWeight: "600",
    color: "#6366f1",
